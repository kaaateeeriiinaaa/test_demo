...
namespace WindowsFormsApp1 {
    ...
    public partial class БиблиотекаDataSet : global::System.Data.DataSet {
        ...
        public partial class АвторDataTable : global::System.Data.TypedTableBase<АвторRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public АвторRow AddАвторRow(int ID_автора, string Фамилия, string Имя, string Отчество) {
...
namespace WindowsFormsApp1.БиблиотекаDataSetTableAdapters {
    ...
    public partial class АвторTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Автор] WHERE (([ID_автора] = @Original_ID_автора) AND ([Фамили" +
                "я] = @Original_Фамилия) AND ([Имя] = @Original_Имя) AND ((@IsNull_Отчество = 1 A" +
                "ND [Отчество] IS NULL) OR ([Отчество] = @Original_Отчество)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Автор] ([ID_автора], [Фамилия], [Имя], [Отчество]) VALUES (@ID" +
                "_автора, @Фамилия, @Имя, @Отчество);\r\nSELECT ID_автора, Фамилия, Имя, Отчество F" +
                "ROM Автор WHERE (ID_автора = @ID_автора)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Автор] SET [ID_автора] = @ID_автора, [Фамилия] = @Фамилия, [Имя] = @Имя, [Отчество] = @Отчество WHERE (([ID_автора] = @Original_ID_автора) AND ([Фамилия] = @Original_Фамилия) AND ([Имя] = @Original_Имя) AND ((@IsNull_Отчество = 1 AND [Отчество] IS NULL) OR ([Отчество] = @Original_Отчество)));
SELECT ID_автора, Фамилия, Имя, Отчество FROM Автор WHERE (ID_автора = @ID_автора)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID_автора, Фамилия, Имя, Отчество FROM dbo.Автор";
        ...
        public virtual int Delete(int Original_ID_автора, string Original_Фамилия, string Original_Имя, string Original_Отчество) {
        ...
        public virtual int Insert(int ID_автора, string Фамилия, string Имя, string Отчество) {
        ...
        public virtual int Update(int ID_автора, string Фамилия, string Имя, string Отчество, int Original_ID_автора, string Original_Фамилия, string Original_Имя, string Original_Отчество) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Фамилия, string Имя, string Отчество, int Original_ID_автора, string Original_Фамилия, string Original_Имя, string Original_Отчество) {
            return this.Update(Original_ID_автора, Фамилия, Имя, Отчество, Original_ID_автора, Original_Фамилия, Original_Имя, Original_Отчество);
        }
    }
