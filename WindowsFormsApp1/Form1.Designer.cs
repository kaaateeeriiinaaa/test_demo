namespace WindowsFormsApp1
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.авторTableAdapter = new WindowsFormsApp1.БиблиотекаDataSetTableAdapters.АвторTableAdapter();
            ...
            this.авторBindingSource.DataSource = this.библиотекаDataSet;
            // 
            // авторTableAdapter
            // 
        ...
        private БиблиотекаDataSetTableAdapters.АвторTableAdapter авторTableAdapter;
